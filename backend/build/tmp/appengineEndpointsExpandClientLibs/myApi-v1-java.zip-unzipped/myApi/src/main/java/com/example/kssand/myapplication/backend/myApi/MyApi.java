 ...
 * on 2016-11-02 at 04:10:54 UTC 
 * Modify at your own risk.
 */

package com.example.kssand.myapplication.backend.myApi;
...
public class MyApi extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  public class RetrieveJoke extends MyApiRequest<com.example.kssand.myapplication.backend.myApi.model.MyBean> {
    ...
    protected RetrieveJoke() {
      super(MyApi.this, "POST", REST_PATH, null, com.example.kssand.myapplication.backend.myApi.model.MyBean.class);
    }
  ...
  public class SayHi extends MyApiRequest<com.example.kssand.myapplication.backend.myApi.model.MyBean> {
